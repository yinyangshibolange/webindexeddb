(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.string.replace.js'), require('core-js/modules/es.regexp.to-string.js'), require('core-js/modules/web.dom-collections.iterator.js'), require('core-js/modules/es.array.sort.js'), require('core-js/modules/es.regexp.test.js'), require('core-js/modules/es.regexp.constructor.js'), require('core-js/modules/es.regexp.dot-all.js'), require('core-js/modules/es.promise.js'), require('core-js/modules/es.array.push.js'), require('core-js/modules/es.error.cause.js')) :
  typeof define === 'function' && define.amd ? define(['core-js/modules/es.regexp.exec.js', 'core-js/modules/es.string.replace.js', 'core-js/modules/es.regexp.to-string.js', 'core-js/modules/web.dom-collections.iterator.js', 'core-js/modules/es.array.sort.js', 'core-js/modules/es.regexp.test.js', 'core-js/modules/es.regexp.constructor.js', 'core-js/modules/es.regexp.dot-all.js', 'core-js/modules/es.promise.js', 'core-js/modules/es.array.push.js', 'core-js/modules/es.error.cause.js'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.IndexdbStore = factory());
